  ...
  module Claims
    class ContractorsAdminController < ApplicationController
      ...
      def order_clause(sort)
        ...
        column =
          case key
          when "business_name" then "contractors.business_name"
          when "number"        then "contractors.number"
          when "email"         then "contractors.email"
          when "created_at"    then "contractors.created_at"
          when "updated_at"    then "contractors.updated_at"
          else

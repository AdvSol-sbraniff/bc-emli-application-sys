...
module Api
  module Claims
    class SupportingDocumentGroupTypeLocatedFieldsAdminController < Api::ApplicationController
      ...
      def show
        row =
          ::Claims::SupportingDocumentGroupTypeLocatedField.find(params[:id])
      ...
      def create
        ...
        row =
          supporting_document_type.supporting_document_group_type_located_fields.create!(
            create_params
          )

    ...
    module AshpGasPropane
      class ApplyRebateCap
        ...
        def rebate_cap_reason_text(result:, failures:, warnings:)
          case result
          when "pass"
            "The named rebate, ASHP upgrade amount, equipment category, and income-level cap are all present, and the rebate is no greater than the eligible ASHP upgrade amount or the base rebate cap. Northern top-up is intentionally excluded and checked by ashp_gas_propane_northern_top_up_within_cap."
          when "fail"

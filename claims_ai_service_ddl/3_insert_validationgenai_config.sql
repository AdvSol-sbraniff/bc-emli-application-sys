...
INSERT INTO claims.validationgenai_config (
  ...
  ON CONFLICT (id) DO UPDATE SET
    ...
    document_triage_deployment_name = EXCLUDED.document_triage_deployment_name,
    supporting_document_extraction_deployment_name = EXCLUDED.supporting_document_extraction_deployment_name,
    upgrade_analysis_deployment_name = EXCLUDED.upgrade_analysis_deployment_name,
    comparison_deployment_name = EXCLUDED.comparison_deployment_name,

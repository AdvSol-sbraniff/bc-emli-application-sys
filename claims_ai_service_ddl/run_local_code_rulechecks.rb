...
#   bin/rails runner claims_ai_service_ddl/run_local_code_rulechecks.rb
#
# Optional target:
#   INVOICE_VERSION_ID=<uuid> bin/rails runner claims_ai_service_ddl/run_local_code_rulechecks.rb
#
# What it does:

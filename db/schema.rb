...
ActiveRecord::Schema[7.1].define(version: 2026_02_19_222612) do
  ...
  create_table "contractor_imports", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["invite_code"], name: "index_contractor_imports_on_invite_code", unique: true
    t.index ["invite_email_sent_at"], name: "index_contractor_imports_on_invite_email_sent_at"
    t.index ["payload"], name: "index_contractor_imports_on_payload", using: :gin
  end

  create_table "contractor_infos", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "contractor_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contractor_id"], name: "index_contractor_infos_on_contractor_id", unique: true
  end

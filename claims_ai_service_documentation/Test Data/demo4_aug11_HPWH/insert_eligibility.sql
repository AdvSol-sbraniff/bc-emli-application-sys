...
BEGIN
  ...
  FROM public.users
  WHERE lower(trim(first_name)) = 'doreen'
    AND lower(trim(last_name)) = 'visia';
  ...
  INSERT INTO claims.users_eligibilitycodes (
    ...
    'de4f0004-0000-4000-8000-000000000004',
    participant_id,
    'ESP1-7a1899b2',
    1,
  ...
  RAISE NOTICE 'Eligibility ESP1-7a1899b2 is ready for Doreen Visia.';
EXCEPTION
  WHEN no_data_found THEN
    RAISE EXCEPTION 'Expected participant Doreen Visia was not found in public.users.';
  WHEN too_many_rows THEN
    RAISE EXCEPTION 'More than one Doreen Visia exists in public.users; eligibility was not changed.';
END
$insert$;
